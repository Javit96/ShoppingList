...
/*Now if you want to protect an endpoint based on a role, 
you just need to add the Authorize attribute like this 
[Authorize(Roles = "OnlyRoleNeed")]. 
In my case would be [Authorize(Roles = "Test")] as this is a 
valid role that exist in my JWT.*/